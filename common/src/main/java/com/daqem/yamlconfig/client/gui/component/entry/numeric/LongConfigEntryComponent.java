...
public class LongConfigEntryComponent extends BaseNumericConfigEntryComponent<LongConfigEntry, Long> {

    public LongConfigEntryComponent(String key, LongConfigEntry configEntry) {
